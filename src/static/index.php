...
?>
<script type="text/javascript" src="javascript.js">document.title = "Pudgy Pigeons"</script>
<body data-bs-spy="scroll" data-bs-target="#mainNavbar" data-bs-offset="50" tabindex="0">
<?php
  include_once("include/loader.html");
...
<main>
      ...
      <div class="bg-img bg-primary">
        ...
        <div class="h-50 w-100">
                ...
                <div class="d-flex justify-content-center h-100">
                  <p class="m-auto text-primary" style="min-height: 250px;">illustration</p>
                </div>
                <!--  -->
        </div>
      </div>
          ...
          <ul class="mw-xl mx-auto pt-6 px-0">
              <li>
                    <div class="list-number">
                      <div style="background-color: #c48bfe;">
                        <div>1</div>
                      </div>
                    </div>
                    <div class="col flex-grow-1 px-2 px-sm-4 py-2">
                      <h2>Title</h2>
                      <span class="w-100 ms-n4 d-block" style="background-color: #c48bfe; height: 10px;"></span>
  ...
  <section id="rarity" class="min-h-0">
      ...
      <div class="col-12 col-lg-6 ms-lg-n7 mt-4 mt-lg-0 px-4 px-md-8 px-lg-0">
        <div class="mx-auto w-100 ps-lg-6 pe-lg-0 pe-xl-6 ms-xl-n4 mt-lg-0">
            <div class="ratio ratio-1x1">
              <!-- TEMPORARY -->
                    <div class="d-flex justify-content-center" style="background-color:#ffcf6e;">
    ...
    <!-- OFFCANVAS -->
      <?php
        include("include/offcanvas-carousel.php");
      ?>
    <!--  -->
  </section>
  <!-- 5 -->
